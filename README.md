...
> **🔍 Purview Audit Log Processor:** Download the script → [`PAX_Purview_Audit_Log_Processor_v1.10.0.ps1`](https://github.com/microsoft/PAX/releases/download/purview-v1.10.0/PAX_Purview_Audit_Log_Processor_v1.10.0.ps1)
>
