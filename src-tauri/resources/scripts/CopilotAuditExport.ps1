...
-LogFile          (Optional)  Path for transcript log. Default: auto-generated .log file in same directory as CSV.
                               Log files use regular text format by default (clean text in any editor) or ANSI color codes
                               (colored text in VS Code, may show escape codes in basic editors) when generated by PAX app.
...
- Log files use plain text format by default for compatibility, or ANSI color format when using PAX app
