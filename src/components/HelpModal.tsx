    ...
    <div role="dialog" aria-modal="true" className="fixed inset-0 z-50 flex items-start justify-center">
      ...
      <div className="relative mt-10 max-w-2xl w-[90%] bg-white rounded shadow-lg ring-1 ring-black/10">
        <div className="px-4 py-3 border-b flex items-center justify-between">
          <h2 className="text-lg font-semibold">Portable Audit eXporter (PAX) — Help</h2>
        ...
        <div className="p-4 space-y-4 max-h-[70vh] overflow-auto text-sm text-gray-800">
          <section>
            ...
            <p>
              A simple desktop wizard to export Microsoft audit events into a CSV file. It guides you
          ...
          <section>
            ...
            <ol className="list-decimal ml-5 space-y-1">
              <li><b>Parameters:</b> Set date range, authentication mode, select activities from curated tiers, and configure advanced settings. Use the Copilot Interaction Only toggle to focus on core Copilot activities. Configure remember preferences for future sessions.</li>
          ...
          <section>
            ...
            <p>
              A CSV file with rows of audit events matching your selected activities and time window. Each row represents activity with columns for timestamp, user, action type, and technical details. The export includes only the specific activity types you selected - no additional keyword searches are performed. Both in-app runs and exported scripts automatically create detailed log files (.log) in the same directory as the CSV output for troubleshooting and audit trails.
            </p>
          </section>
          <section>
            ...
            <div className="space-y-2 text-sm">
              ...
              <p><b>Required Permissions:</b> Your account needs Exchange Online management permissions and audit log access. The script tests these permissions by attempting a sample audit query before beginning the full export.</p>
            ...
            <div className="space-y-2">
              <div>
                ...
                <ul className="list-disc ml-5">
                  ...
                  <li><b>Copilot Interaction Only:</b> Toggle to focus exclusively on core Copilot activities (CopilotInteraction operations). When enabled, activity selection is disabled and filtered automatically.</li>
                  <li><b>Activities Selection:</b> Choose from dynamically loaded activity catalog organized by tiers. Use <i>List view</i> toggle (Curated/Full) to control catalog scope. Use <i>Select Recommended</i> or <i>Select Everything</i> buttons for quick selection.</li>
              ...
              <div>
                ...
                <ul className="list-disc ml-5">
                  <li><b>Status &amp; Progress:</b> Color-coded status badge (Running/Success/Error/No Results) with dual progress bars - overall export progress and current task progress with phase indicators (queries/post).</li>
