...
> **🚀 Quick Start:** Download the script → [`PAX_Graph_Audit_Log_Processor_v0.1.2.ps1`](https://github.com/microsoft/PAX/releases/download/graph-v0.1.2/PAX_Graph_Audit_Log_Processor_v0.1.2.ps1)
>
> **📋 Release Notes:** See what's new → [v0.1.2 Release Notes](https://github.com/microsoft/PAX/blob/release/release_notes/Graph_Audit_Log_Processor/PAX_Graph_Audit_Log_Processor_Release_Note_v0.1.2.md) | [All Release Notes](https://github.com/microsoft/PAX/tree/release/release_notes/Graph_Audit_Log_Processor)
>
> **📜 Previous Script Versions:** [All Graph Releases](https://github.com/microsoft/PAX/releases?q=graph-&expanded=true)
>
> **📚 Documentation Archive:** [v0.1.2 MD](https://github.com/microsoft/PAX/blob/release/release_documentation/Graph_Audit_Log_Processor/PAX_Graph_Audit_Log_Processor_Documentation_v0.1.2.md) | [All Documentation](https://github.com/microsoft/PAX/tree/release/release_documentation/Graph_Audit_Log_Processor)
...
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D30 -IncludeCopilot -IncludeEntraUsers -CombineOutput -OutputFileName "Copilot_Adoption_Report.csv"
```
...
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D90 -IncludeCurated -IncludeEntraUsers -CombineOutput
```
...
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D180 -CombineOutput
```
...
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D7 -IncludeCurated -IncludeEntraUsers -CombineOutput -OutputFileName "PowerBI_M365_Usage.csv"
```
...
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D180 -IncludeCurated -IncludeEntraUsers -CombineOutput
```
...
Invoke-WebRequest -Uri "https://github.com/microsoft/PAX/releases/download/graph-v0.1.2/PAX_Graph_Audit_Log_Processor_v0.1.2.ps1" -OutFile "PAX_Graph_Audit_Log_Processor_v0.1.2.ps1"
```
...
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D7
```
...
```powershell
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D30 -OutputPath "C:\Reports\M365"
```

### Device Code Authentication (Limited Browser)

```powershell
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D7 -Auth DeviceCode
```
...
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D30 -Auth Credential
```
...
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1

# Specify 30-day period
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D30

# Get all available historical data
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period ALL
```
...
**Example:**
```powershell
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D7 -OutputPath "C:\Reports"
```
...
```powershell
# Custom filename
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D7 -CombineOutput -OutputFileName "Weekly_Report.csv"

# Auto-generated timestamped filename
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D7 -CombineOutput
```
...
**Example:**
```powershell
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D30 -CombineOutput
```
...
**Example:**
```powershell
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D7 -IncludeCopilot
```
...
**Example:**
```powershell
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D30 -IncludeCurated
```
...
**Example:**
```powershell
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D7 -IncludeEntraUsers
```
...
**Example:**
```powershell
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D30 -ExplodeArrays
```
...
**Example:**
```powershell
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D30 -PacingMs 100
```
...
**Example:**
```powershell
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Help
```
...
### Example
```powershell
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D30 -Auth DeviceCode
...
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D30 -Auth Silent
```
...
### Last 90 Days
```powershell
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D90
```

### Custom Output Location
```powershell
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D7 -OutputPath "C:\Reports\M365"
```
...
```powershell
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period ALL -CombineOutput -OutputFileName "Historical_Analysis.csv"
```

### Quarterly Review
```powershell
# 90-day period for Q1 review
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D90 -IncludeCurated -IncludeEntraUsers -CombineOutput -OutputFileName "Q1_Review.csv"
```
...
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D7 -CombineOutput -OutputFileName "PowerBI_M365_Usage.csv" -OutputPath "C:\PowerBI\Data"
```

### Weekly Snapshot
```powershell
# Scheduled task: runs Monday at 6 AM
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D30 -CombineOutput -OutputFileName "Weekly_Snapshot.csv" -OutputPath "C:\PowerBI\Data"
```
...
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D30 -CombineOutput -OutputFileName "Monthly_Report.csv"
```
...
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D30 -IncludeCopilot -IncludeEntraUsers -CombineOutput
```
...
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D90 -IncludeCurated -CombineOutput -PacingMs 200
```

### Array Explosion for License Details
```powershell
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D30 -IncludeEntraUsers -ExplodeArrays -CombineOutput
```

### Device Code Authentication
```powershell
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D7 -IncludeCurated -Auth DeviceCode -CombineOutput
```
...
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D30 -IncludeCurated -Auth Credential -CombineOutput -OutputFileName "Automated_Report.csv"
```
...
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D30 -CombineOutput -OutputFileName "My_Report.csv"
...
```powershell
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D90 -IncludeCurated -PacingMs 200
```
...
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D30 -IncludeCopilot  # +1 endpoint
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D30 -IncludeEntraUsers  # +user enrichment
```

#### 4. Use Client Secret Authentication
```powershell
# Faster than interactive login (no browser overhead)
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D30 -IncludeCurated -Auth Credential
```
...
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D7 -CombineOutput -OutputFileName "Daily_Refresh.csv" -Auth Credential
```

#### Weekly Summary
```powershell
# Balanced: D30 period for trend analysis
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D30 -CombineOutput -OutputFileName "Weekly_Summary.csv" -Auth Credential
```
...
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D180 -CombineOutput -OutputFileName "Historical_Trends.csv"

# All available data
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period ALL -CombineOutput -OutputFileName "Complete_History.csv"
```
...
**Example:**
```powershell
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D90 -PacingMs 250
```
...
**Solution:**
```powershell
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D30 -PacingMs 200
```
...
```powershell
# Last 6 months
.\PAX_Graph_Audit_Log_Processor_v0.1.2.ps1 -Period D180 -CombineOutput -OutputFileName "Last_6_Months.csv"
