...
> **📥 Quick Start:** Download the script → [`PAX_Purview_Audit_Log_Processor_v1.10.4.ps1`](https://github.com/microsoft/PAX/releases/download/purview-v1.10.4/PAX_Purview_Audit_Log_Processor_v1.10.4.ps1)
>
...
**Script:** `PAX_Purview_Audit_Log_Processor_v1.10.4.ps1`  
