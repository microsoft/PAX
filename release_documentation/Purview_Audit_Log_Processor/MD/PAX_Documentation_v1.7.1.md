...
> **🔍 Purview Audit Log Processor:** Download the script → [`PAX_Purview_Audit_Log_Processor_v1.7.1.ps1`](https://github.com/microsoft/PAX/releases/download/purview-v1.7.0/PAX_Purview_Audit_Log_Processor_v1.7.1.ps1)
>
...
> **📊 Graph API Audit Log Processor:** Download the script → [`PAX_Graph_Audit_Log_Processor_v0.1.0.ps1`](https://github.com/microsoft/PAX/releases/download/graph-v0.1.0/PAX_Graph_Audit_Log_Processor_v0.1.0.ps1)
>
